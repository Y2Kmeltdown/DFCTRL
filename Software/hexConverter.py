...
# parameterMem = "parameterMem.txt"
# parameterMemHex = "parameterMem.hex"

# with open(parameterMem, "r") as param, open(parameterMemHex, "w") as paramHex:
#     for line in param.readlines():
#         hex(int(line.rstrip(), 2))[2:]
#         paramHex.write(":"+hex(int(line.rstrip(), 2))[2:]+"\n")
#     pass
